        ...
        <div className='container f_flex top'>
          <div className='left top'>
            ...
            <h2>
              ...
              <span>
                <Typewriter words={[" Programador Intermédio.", " Desenhista.", " Aspirante a Escritor.", " Amante de Computadores.", " Pensador e Observador."]} loop cursor cursorStyle='|' typeSpeed={70} deleteSpeed={50} delaySpeed={1000} />
              </span>
            </h2>

            <p>Um jovem amante de Artes, Desenhista, Aspirante a Escritor, Gamer, Nerd, Geek e Criativo. Gosto de assistir animes e jogar vídeo jogos. Quando tenho um pouco de tempo livre, gosto de ler bandas desenhadas.</p>
